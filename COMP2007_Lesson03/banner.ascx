<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="banner.ascx.cs" Inherits="COMP2007_Lesson03.banner" %>


<asp:Panel ID="pnlVertical" runat="server">
    <asp:HyperLink ID="lnkVertical" runat="server" NavigateUrl="http://www.georgiancollege.ca">
        <asp:Image ID="imgVertical" runat="server" AlternateText="Georgian Logo" ImageUrl="~/images/logo_portrait.jpg" />
    </asp:HyperLink>
</asp:Panel>
